...
export const services: ServiceDef[] = [
  // Particle Data Platform
  {
    ...
    description:
      "Podcast, people, and company intelligence: search shows, retrieve transcripts, discover guests and advertisers, and traverse a connected knowledge graph. Pay per request with USDC on Base through native MPP evm/charge; no account or prepaid credits required.",
    docs: {
      apiReference: "https://api.particle.pro/openapi.json",
      homepage: "https://docs.particle.pro/mpp",
      llmsTxt: "https://api.particle.pro/llms.txt",
    },
    endpoints: [
      {
        amount: "10000",
        desc: "List companies",
        docs: "https://docs.particle.pro/api-reference/companies/list-companies",
      ...
      },
      {
        amount: "10000",
        desc: "Get a company",
        docs: "https://docs.particle.pro/api-reference/companies/get-a-company",
        route: "GET /v1/companies/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List company competitors",
        docs: "https://docs.particle.pro/api-reference/companies/list-company-competitors",
        route: "GET /v1/companies/:id/competitors",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List company people",
        docs: "https://docs.particle.pro/api-reference/companies/list-company-people",
        route: "GET /v1/companies/:id/people",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get company advertising profile",
        docs: "https://docs.particle.pro/api-reference/companies/get-company-advertising-profile",
        route: "GET /v1/companies/:id/podcast/advertising",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List company podcast advertising placements",
        docs: "https://docs.particle.pro/api-reference/companies/list-company-podcast-advertising-placements",
        route: "GET /v1/companies/:id/podcast/advertising/placements",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcasts carrying company advertising",
        docs: "https://docs.particle.pro/api-reference/companies/list-podcasts-carrying-company-advertising",
        route: "GET /v1/companies/:id/podcast/advertising/podcasts",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcasts a company could advertise on next",
        docs: "https://docs.particle.pro/api-reference/companies/list-podcasts-a-company-could-advertise-on-next",
        route: "GET /v1/companies/:id/podcast/recommendations",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List company products",
        docs: "https://docs.particle.pro/api-reference/companies/list-company-products",
        route: "GET /v1/companies/:id/products",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List entities",
        docs: "https://docs.particle.pro/api-reference/entities/list-entities",
        route: "GET /v1/entities",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Search entities",
        docs: "https://docs.particle.pro/api-reference/entities/search-entities",
        route: "GET /v1/entities/search",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List entity types",
        docs: "https://docs.particle.pro/api-reference/entities/list-entity-types",
        route: "GET /v1/entities/types",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get an entity",
        docs: "https://docs.particle.pro/api-reference/entities/get-an-entity",
        route: "GET /v1/entities/:id",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get a Person",
        docs: "https://docs.particle.pro/api-reference/people/get-a-person",
        route: "GET /v1/people/:id",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List a Person's external profiles",
        docs: "https://docs.particle.pro/api-reference/people/list-a-persons-external-profiles",
        route: "GET /v1/people/:slug/external-links",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List and search podcasts",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-and-search-podcasts",
        route: "GET /v1/podcasts",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get sponsor co-occurrence",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-sponsor-co-occurrence",
        route: "GET /v1/podcasts/advertising/co-occurrence",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get advertising leaderboard",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-advertising-leaderboard",
        route: "GET /v1/podcasts/advertising/leaderboard",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get advertising leaderboard preview",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-advertising-leaderboard-preview",
        route: "GET /v1/podcasts/advertising/leaderboard/preview",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get publisher advertising leaderboard",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-publisher-advertising-leaderboard",
        route: "GET /v1/podcasts/advertising/publishers/leaderboard",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List sponsors",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-sponsors",
        route: "GET /v1/podcasts/advertising/sponsors",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List trending sponsors",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-trending-sponsors",
        route: "GET /v1/podcasts/advertising/sponsors/trends",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a sponsor",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-a-sponsor",
        route: "GET /v1/podcasts/advertising/sponsors/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcasts for a sponsor",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-podcasts-for-a-sponsor",
        route: "GET /v1/podcasts/advertising/sponsors/:id/podcasts",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List publishers for a sponsor",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-publishers-for-a-sponsor",
        route: "GET /v1/podcasts/advertising/sponsors/:id/publishers",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List ad segments for a sponsor",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-ad-segments-for-a-sponsor",
        route: "GET /v1/podcasts/advertising/sponsors/:id/segments",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get advertising timeseries",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-advertising-timeseries",
        route: "GET /v1/podcasts/advertising/timeseries",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Rank publishers by political bias metric",
        docs: "https://docs.particle.pro/api-reference/podcast-bias/rank-publishers-by-political-bias-metric",
        route: "GET /v1/podcasts/bias/publishers/leaderboard",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List publishers with podcasts in a bias bucket",
        docs: "https://docs.particle.pro/api-reference/podcast-bias/list-publishers-with-podcasts-in-a-bias-bucket",
        route: "GET /v1/podcasts/bias/:result/publishers",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List clips",
        docs: "https://docs.particle.pro/api-reference/podcast-clips/list-clips",
        route: "GET /v1/podcasts/clips",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a clip",
        docs: "https://docs.particle.pro/api-reference/podcast-clips/get-a-clip",
        route: "GET /v1/podcasts/clips/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get clip transcript",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-clip-transcript",
        route: "GET /v1/podcasts/clips/:id/transcript",
        unitType: "request",
      },
      {
        amount: "100000",
        desc: "List entity charts",
        docs: "https://docs.particle.pro/api-reference/entity-charts/list-entity-charts",
        route: "GET /v1/podcasts/entities/charts",
        unitType: "request",
      },
      {
        amount: "100000",
        desc: "Get an entity chart",
        docs: "https://docs.particle.pro/api-reference/entity-charts/get-an-entity-chart",
        route: "GET /v1/podcasts/entities/charts/:category",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List episodes",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-episodes",
        route: "GET /v1/podcasts/episodes",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Poll the episode feed",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/poll-the-episode-feed",
        route: "GET /v1/podcasts/episodes/feed",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Look up episodes by external identifier",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/look-up-episodes-by-external-identifier",
        route: "GET /v1/podcasts/episodes/lookup",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Search podcast episode content",
        docs: "https://docs.particle.pro/api-reference/podcast-episode-search/search-podcast-episode-content",
        route: "GET /v1/podcasts/episodes/search",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get episode timeseries",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/get-episode-timeseries",
        route: "GET /v1/podcasts/episodes/timeseries",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/get-an-episode",
        route: "GET /v1/podcasts/episodes/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List ads in an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-ads-in-an-episode",
        route: "GET /v1/podcasts/episodes/:id/ads",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List clips for an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-clips/list-clips-for-an-episode",
        route: "GET /v1/podcasts/episodes/:id/clips",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List entities in an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-entities-in-an-episode",
        route: "GET /v1/podcasts/episodes/:id/entities",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List related episodes",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-related-episodes",
        route: "GET /v1/podcasts/episodes/:id/related",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List segments for an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-segments/list-segments-for-an-episode",
        route: "GET /v1/podcasts/episodes/:id/segments",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List speakers in an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-speakers-in-an-episode",
        route: "GET /v1/podcasts/episodes/:id/speakers",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List topics for an episode",
        docs: "https://docs.particle.pro/api-reference/podcast-episodes/list-topics-for-an-episode",
        route: "GET /v1/podcasts/episodes/:id/topics",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get episode transcript",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-episode-transcript",
        route: "GET /v1/podcasts/episodes/:id/transcript",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get entity mentions in transcript",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-entity-mentions-in-transcript",
        route: "GET /v1/podcasts/episodes/:id/transcript/mentions",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get a transcript excerpt around a moment",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-a-transcript-excerpt-around-a-moment",
        route: "GET /v1/podcasts/episodes/:id/transcript/preview",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get word-level transcript",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-word-level-transcript",
        route: "GET /v1/podcasts/episodes/:id/transcript/words",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcast guests",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-podcast-guests",
        route: "GET /v1/podcasts/guests",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List trending podcast guests",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-trending-podcast-guests",
        route: "GET /v1/podcasts/guests/trends",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a podcast guest profile",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/get-a-podcast-guest-profile",
        route: "GET /v1/podcasts/guests/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List appearances for a podcast guest",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-appearances-for-a-podcast-guest",
        route: "GET /v1/podcasts/guests/:id/appearances",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List podcasts a guest has appeared on",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-podcasts-a-guest-has-appeared-on",
        route: "GET /v1/podcasts/guests/:id/podcasts",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcasts a guest could plausibly appear on next",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-podcasts-a-guest-could-plausibly-appear-on-next",
        route: "GET /v1/podcasts/guests/:id/recommendations/podcasts",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get a guest's brand-suitability exposure profile",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/get-a-guests-brand-suitability-exposure-profile",
        route: "GET /v1/podcasts/guests/:id/suitability",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Look up podcasts by external platform identifier",
        docs: "https://docs.particle.pro/api-reference/podcasts/look-up-podcasts-by-external-platform-identifier",
        route: "GET /v1/podcasts/lookup",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Search podcast dialogue for entity mentions",
        docs: "https://docs.particle.pro/api-reference/podcast-episode-search/search-podcast-dialogue-for-entity-mentions",
        route: "GET /v1/podcasts/mentions",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get mention timeseries",
        docs: "https://docs.particle.pro/api-reference/podcast-episode-search/get-mention-timeseries",
        route: "GET /v1/podcasts/mentions/timeseries",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcast publishers",
        docs: "https://docs.particle.pro/api-reference/podcast-publishers/list-podcast-publishers",
        route: "GET /v1/podcasts/publishers",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a podcast publisher",
        docs: "https://docs.particle.pro/api-reference/podcast-publishers/get-a-podcast-publisher",
        route: "GET /v1/podcasts/publishers/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get publisher advertising profile",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/get-publisher-advertising-profile",
        route: "GET /v1/podcasts/publishers/:id/advertising",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List publisher's podcasts ranked by ad volume",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-publishers-podcasts-ranked-by-ad-volume",
        route: "GET /v1/podcasts/publishers/:id/advertising/podcasts",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List sponsors for a publisher",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-sponsors-for-a-publisher",
        route: "GET /v1/podcasts/publishers/:id/advertising/sponsors",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get publisher political bias profile",
        docs: "https://docs.particle.pro/api-reference/podcast-bias/get-publisher-political-bias-profile",
        route: "GET /v1/podcasts/publishers/:id/bias",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List analyzed podcasts for a publisher",
        docs: "https://docs.particle.pro/api-reference/podcast-bias/list-analyzed-podcasts-for-a-publisher",
        route: "GET /v1/podcasts/publishers/:id/bias/podcasts",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List podcasts for a publisher",
        docs: "https://docs.particle.pro/api-reference/podcast-publishers/list-podcasts-for-a-publisher",
        route: "GET /v1/podcasts/publishers/:id/podcasts",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get a publisher's brand suitability profile",
        docs: "https://docs.particle.pro/api-reference/podcast-publishers/get-a-publishers-brand-suitability-profile",
        route: "GET /v1/podcasts/publishers/:id/suitability",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List a publisher's podcasts with their suitability verdicts",
        docs: "https://docs.particle.pro/api-reference/podcast-publishers/list-a-publishers-podcasts-with-their-suitability-verdicts",
        route: "GET /v1/podcasts/publishers/:id/suitability/podcasts",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcast rankings",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-podcast-rankings",
        route: "GET /v1/podcasts/rankings",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List ranking categories",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-ranking-categories",
        route: "GET /v1/podcasts/rankings/categories",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List ranking countries",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-ranking-countries",
        route: "GET /v1/podcasts/rankings/countries",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get chart slot history",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/get-chart-slot-history",
        route: "GET /v1/podcasts/rankings/history",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List ranking movers",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-ranking-movers",
        route: "GET /v1/podcasts/rankings/movers",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List ranking sources",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-ranking-sources",
        route: "GET /v1/podcasts/rankings/sources",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Search podcasts",
        docs: "https://docs.particle.pro/api-reference/podcasts/search-podcasts",
        route: "GET /v1/podcasts/search",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List segments",
        docs: "https://docs.particle.pro/api-reference/podcast-segments/list-segments",
        route: "GET /v1/podcasts/segments",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get a segment",
        docs: "https://docs.particle.pro/api-reference/podcast-segments/get-a-segment",
        route: "GET /v1/podcasts/segments/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get segment transcript",
        docs: "https://docs.particle.pro/api-reference/podcast-transcripts/get-segment-transcript",
        route: "GET /v1/podcasts/segments/:id/transcript",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get publishers ranked by exposure to a brand-safety category",
        docs: "https://docs.particle.pro/api-reference/podcast-brand-suitability/get-publishers-ranked-by-exposure-to-a-brand-safety-category",
        route: "GET /v1/podcasts/suitability/categories/:code/publishers",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get a cross-publisher suitability leaderboard",
        docs: "https://docs.particle.pro/api-reference/podcast-brand-suitability/get-a-cross-publisher-suitability-leaderboard",
        route: "GET /v1/podcasts/suitability/publishers/leaderboard",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List podcast topics",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-podcast-topics",
        route: "GET /v1/podcasts/topics",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get a podcast",
        docs: "https://docs.particle.pro/api-reference/podcasts/get-a-podcast",
        route: "GET /v1/podcasts/:id",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get podcast advertising profile",
        docs: "https://docs.particle.pro/api-reference/podcasts/get-podcast-advertising-profile",
        route: "GET /v1/podcasts/:id/advertising",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List sponsors advertising on a podcast",
        docs: "https://docs.particle.pro/api-reference/podcast-advertising/list-sponsors-advertising-on-a-podcast",
        route: "GET /v1/podcasts/:id/advertising/sponsors",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a podcast's latest bias analysis",
        docs: "https://docs.particle.pro/api-reference/podcasts/get-a-podcasts-latest-bias-analysis",
        route: "GET /v1/podcasts/:id/bias",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List episodes for a podcast",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-episodes-for-a-podcast",
        route: "GET /v1/podcasts/:id/episodes",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "List a podcast's third-party platform presences",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-a-podcasts-third-party-platform-presences",
        route: "GET /v1/podcasts/:id/external-links",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Get a podcast's format profile",
        docs: "https://docs.particle.pro/api-reference/podcasts/get-a-podcasts-format-profile",
        route: "GET /v1/podcasts/:id/format",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List the guest roster for a podcast",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-the-guest-roster-for-a-podcast",
        route: "GET /v1/podcasts/:id/guests",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List entity mentions in a podcast",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-entity-mentions-in-a-podcast",
        route: "GET /v1/podcasts/:id/mentions",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List current rankings for a podcast",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/list-current-rankings-for-a-podcast",
        route: "GET /v1/podcasts/:id/rankings",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get historical rankings for a podcast",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/get-historical-rankings-for-a-podcast",
        route: "GET /v1/podcasts/:id/rankings/history",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Summarize a podcast's chart presence",
        docs: "https://docs.particle.pro/api-reference/podcast-rankings/summarize-a-podcasts-chart-presence",
        route: "GET /v1/podcasts/:id/rankings/summary",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List ratings for a podcast",
        docs: "https://docs.particle.pro/api-reference/podcast-ratings/list-ratings-for-a-podcast",
        route: "GET /v1/podcasts/:id/ratings",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "Summarize a podcast's ratings",
        docs: "https://docs.particle.pro/api-reference/podcast-ratings/summarize-a-podcasts-ratings",
        route: "GET /v1/podcasts/:id/ratings/summary",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List guests a podcast could plausibly book",
        docs: "https://docs.particle.pro/api-reference/podcast-guests/list-guests-a-podcast-could-plausibly-book",
        route: "GET /v1/podcasts/:id/recommendations/guests",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List sponsors a podcast could pitch",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-sponsors-a-podcast-could-pitch",
        route: "GET /v1/podcasts/:id/recommendations/sponsors",
        unitType: "request",
      },
      {
        amount: "30000",
        desc: "List related podcasts",
        docs: "https://docs.particle.pro/api-reference/podcasts/list-related-podcasts",
        route: "GET /v1/podcasts/:id/related",
        unitType: "request",
      },
      {
        amount: "40000",
        desc: "Get a podcast's latest brand suitability assessment",
        docs: "https://docs.particle.pro/api-reference/podcasts/get-a-podcasts-latest-brand-suitability-assessment",
        route: "GET /v1/podcasts/:id/suitability",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "List topics",
        docs: "https://docs.particle.pro/api-reference/topics/list-topics",
        route: "GET /v1/topics",
        unitType: "request",
      },
      {
        amount: "10000",
        desc: "Get a topic",
        docs: "https://docs.particle.pro/api-reference/topics/get-a-topic",
        route: "GET /v1/topics/:id",
        unitType: "request",
      },
    ],
    icon: "https://docs.particle.pro/favicon.png",
    id: "particle",
    integration: "first-party",
    intent: "charge",
    name: "Particle Data Platform",
    payments: [
      {
    ...
    realm: "api.particle.pro",
    serviceUrl: "https://api.particle.pro",
    status: "active",
    tags: ["base", "companies", "people", "podcasts", "transcripts", "usdc"],
    url: "https://particle.pro",
  },
  {
    categories: ["data", "media", "search"],
    description:
      "Particle podcast, people, and company intelligence over MCP Streamable HTTP. Initialize and discover tools for free, then pay each billable tool call with USDC on Base through native MPP evm/charge.",
    docs: {
      apiReference: "https://mcp.particle.pro/openapi.json",
      homepage: "https://docs.particle.pro/mpp",
      llmsTxt: "https://mcp.particle.pro/llms.txt",
    },
    endpoints: [
      {
        amountHint:
          "Sum of the billable tools/call prices in the request; prices start at $0.01 USDC. initialize, tools/list, ping, and free tools are free. See llms.txt for individual tool prices.",
        desc: "Call Particle MCP tools over Streamable HTTP",
        docs: "https://mcp.particle.pro/llms.txt",
        dynamic: true,
        route: "POST /mcp",
        unitType: "tool call",
      },
    ...
    integration: "first-party",
    intent: "charge",
    name: "Particle Data Platform MCP",
    payments: [
      {
        currency: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913",
        decimals: 6,
    ...
    realm: "mcp.particle.pro",
    serviceUrl: "https://mcp.particle.pro",
    status: "active",
    tags: ["base", "companies", "people", "podcasts", "transcripts", "usdc"],
    url: "https://particle.pro",
  },
