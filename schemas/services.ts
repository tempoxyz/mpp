...
export const services: ServiceDef[] = [
  ...
  // ── Nansen ──────────────────────────────────────────────────────────────
  {
    ...
    endpoints: [
      ...
      // Smart Money
      { route: "POST /api/v1/smart-money/netflow", desc: "Net token flows by smart money addresses", amount: "50000" },
      { route: "POST /api/v1/smart-money/dex-trades", desc: "Smart money DEX trades", amount: "50000" },
      { route: "POST /api/v1/smart-money/perp-trades", desc: "Smart money perp trades on Hyperliquid", amount: "50000" },
      { route: "POST /api/v1/smart-money/dcas", desc: "Smart money DCA orders on Solana", amount: "50000" },
      { route: "POST /api/v1/smart-money/holdings", desc: "Smart money aggregated token balances", amount: "50000" },
      { route: "POST /api/v1/smart-money/historical-holdings", desc: "Historical smart money holdings", amount: "10000" },
      // Profiler
      { route: "POST /api/v1/profiler/address/transactions", desc: "Wallet transaction history", amount: "10000" },
      { route: "POST /api/v1/transaction-with-token-transfer-lookup", desc: "Transaction with token transfer lookup", amount: "10000" },
      { route: "POST /api/v1/profiler/address/pnl-summary", desc: "Trade summary with top 5 trades", amount: "10000" },
      { route: "POST /api/v1/profiler/address/current-balance", desc: "Current token balances of an address", amount: "10000" },
      { route: "POST /api/v1/profiler/address/counterparties", desc: "Top counterparties of a wallet", amount: "50000" },
      { route: "POST /api/v1/profiler/address/historical-balances", desc: "Historical wallet balances", amount: "10000" },
      { route: "POST /api/v1/profiler/address/related-wallets", desc: "Related wallets and first-degree relations", amount: "10000" },
      { route: "POST /api/v1/profiler/address/pnl", desc: "Past trades and PnL performance", amount: "10000" },
      { route: "POST /api/v1/profiler/address/labels", desc: "Address labels and entity tags" },
      { route: "POST /api/v1/profiler/address/premium-labels", desc: "Premium address labels and entity tags" },
      { route: "POST /api/v1/profiler/perp-positions", desc: "Wallet perp positions and account health", amount: "10000" },
      { route: "POST /api/v1/profiler/perp-trades", desc: "Wallet Hyperliquid trade history", amount: "10000" },
      // Token God Mode
      { route: "POST /api/v1/tgm/flows", desc: "Total token inflow and outflow", amount: "10000" },
      { route: "POST /api/v1/tgm/who-bought-sold", desc: "Recent buyers and sellers summary", amount: "10000" },
      { route: "POST /api/v1/tgm/dex-trades", desc: "All DEX trades of a token", amount: "10000" },
      { route: "POST /api/v1/tgm/transfers", desc: "Top token transfers", amount: "10000" },
      { route: "POST /api/v1/tgm/holders", desc: "Top holders by entity category", amount: "50000" },
      { route: "POST /api/v1/tgm/pnl-leaderboard", desc: "Top addresses by realized and unrealized PnL", amount: "50000" },
      { route: "POST /api/v1/tgm/perp-pnl-leaderboard", desc: "Perp PnL leaderboard for a token", amount: "50000" },
      { route: "POST /api/v1/tgm/perp-positions", desc: "Open perp positions for a token", amount: "50000" },
      { route: "POST /api/v1/tgm/perp-trades", desc: "Perp trading history for a token", amount: "10000" },
      { route: "POST /api/v1/tgm/flow-intelligence", desc: "Token flow summary across smart money and exchanges", amount: "10000" },
      { route: "POST /api/v1/tgm/position-intelligence", desc: "Token position intelligence", amount: "10000" },
      { route: "POST /api/v1/tgm/token-information", desc: "Token metadata: market cap, volume, holders", amount: "10000" },
      { route: "POST /api/v1/tgm/indicators", desc: "Risk and reward indicators for a token", amount: "50000" },
      { route: "POST /api/v1/tgm/token-ohlcv", desc: "Token OHLCV price data", amount: "10000" },
      { route: "POST /api/v1/tgm/jup-dca", desc: "Jupiter DCA orders for a token on Solana", amount: "10000" },
      // Screeners
      { route: "POST /api/v1/token-screener", desc: "Real-time token analytics across chains", amount: "10000" },
      { route: "POST /api/v1/perp-screener", desc: "Screen Hyperliquid tokens by volume", amount: "10000" },
      // Portfolio
      { route: "POST /api/v1/portfolio/defi-holdings", desc: "Track DeFi positions across addresses" },
      // Search
      { route: "POST /api/v1/search/entity-name", desc: "Search for entity names" },
      { route: "GET /api/v1/search/token-sectors", desc: "List token sectors" },
      { route: "POST /api/v1/search/general", desc: "General search" },
      // Perp Leaderboard
      { route: "POST /api/v1/perp-leaderboard", desc: "Most profitable Hyperliquid addresses", amount: "50000" },
      // Prediction Market
      { route: "POST /api/v1/prediction-market/ohlcv", desc: "Prediction market OHLCV data", amount: "10000" },
      { route: "POST /api/v1/prediction-market/orderbook", desc: "Prediction market orderbook", amount: "10000" },
      { route: "POST /api/v1/prediction-market/top-holders", desc: "Top holders in prediction market", amount: "50000" },
      { route: "POST /api/v1/prediction-market/trades-by-market", desc: "Trades by prediction market", amount: "10000" },
      { route: "POST /api/v1/prediction-market/market-screener", desc: "Screen prediction markets", amount: "10000" },
      { route: "POST /api/v1/prediction-market/event-screener", desc: "Screen prediction market events", amount: "10000" },
      { route: "POST /api/v1/prediction-market/pnl-by-market", desc: "PnL by prediction market", amount: "50000" },
      { route: "POST /api/v1/prediction-market/pnl-by-address", desc: "PnL by address in prediction markets", amount: "10000" },
      { route: "POST /api/v1/prediction-market/position-detail", desc: "Prediction market position details", amount: "50000" },
      { route: "POST /api/v1/prediction-market/trades-by-address", desc: "Trades by address in prediction markets", amount: "10000" },
      { route: "POST /api/v1/prediction-market/categories", desc: "Prediction market categories", amount: "10000" },
    ],
  },
