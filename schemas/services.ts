...
export const services: ServiceDef[] = [
  ...
  // ── Surf Twitter ─────────────────────────────────────────────────────
  {
    ...
    serviceUrl: "https://twitter.surf.cascade.fyi",
    description: "Twitter/X data API. Search tweets, look up users and tweets, browse lists, communities, spaces, and trends.",
    categories: ["social", "data"],
    integration: "first-party",
    tags: [
      "twitter",
    ...
    docs: {
      ...
      apiReference: "https://twitter.surf.cascade.fyi",
    },
    provider: { name: "Cascade", url: "https://surf.cascade.fyi" },
    realm: "twitter.surf.cascade.fyi",
    intent: "charge",
    payment: TEMPO_PAYMENT,
    endpoints: [
      { route: "GET /tweets/search", desc: "Search tweets with advanced operators", amount: "5000" },
      { route: "GET /tweets/:id", desc: "Get a single tweet by ID", amount: "1000" },
      { route: "GET /tweets", desc: "Get multiple tweets by IDs (batch)", amount: "4000" },
      { route: "GET /tweets/:id/replies", desc: "Get replies to a tweet", amount: "4000" },
      { route: "GET /tweets/:id/quotes", desc: "Get quote tweets", amount: "4000" },
      { route: "GET /tweets/:id/retweeters", desc: "Get users who retweeted a tweet", amount: "4000" },
      { route: "GET /tweets/:id/thread", desc: "Get full thread for a tweet", amount: "4000" },
      { route: "GET /tweets/:id/article", desc: "Get Twitter article content", amount: "5000" },
      { route: "GET /users/search", desc: "Search users by keyword", amount: "4000" },
      { route: "GET /users/relationship", desc: "Check follow relationship between two users", amount: "1000" },
      { route: "GET /users/:ref", desc: "Get user profile by username or ID", amount: "1000" },
      { route: "GET /users", desc: "Get multiple users by IDs (batch)", amount: "4000" },
      { route: "GET /users/:ref/tweets", desc: "Get a user's tweets", amount: "4000" },
      { route: "GET /users/:ref/mentions", desc: "Get tweets mentioning a user", amount: "4000" },
      { route: "GET /users/:ref/followers", desc: "Get a user's followers", amount: "4000" },
      { route: "GET /users/:ref/following", desc: "Get accounts a user follows", amount: "4000" },
      { route: "GET /users/:ref/verified_followers", desc: "Get a user's verified followers", amount: "4000" },
      { route: "GET /lists/:id/tweets", desc: "Get tweets from a list", amount: "4000" },
      { route: "GET /lists/:id/members", desc: "Get members of a list", amount: "4000" },
      { route: "GET /lists/:id/followers", desc: "Get followers of a list", amount: "4000" },
      { route: "GET /communities/search", desc: "Search communities", amount: "4000" },
      { route: "GET /communities/:id", desc: "Get community details", amount: "4000" },
      { route: "GET /communities/:id/tweets", desc: "Get tweets in a community", amount: "4000" },
      { route: "GET /communities/:id/members", desc: "Get community members", amount: "4000" },
      { route: "GET /spaces/:id", desc: "Get Twitter Space details", amount: "1000" },
      { route: "GET /trends", desc: "Get trending topics", amount: "1000" },
    ],
  },
  ...
  // ── Surf Reddit ──────────────────────────────────────────────────────
  {
    ...
    serviceUrl: "https://reddit.surf.cascade.fyi",
    description: "Reddit data API. Search posts, browse subreddits, read threads with comments, and look up user profiles.",
    categories: ["social", "data"],
    integration: "first-party",
    tags: [
      "reddit",
    ...
    docs: {
      homepage: "https://surf.cascade.fyi",
      apiReference: "https://reddit.surf.cascade.fyi",
    },
    provider: { name: "Cascade", url: "https://surf.cascade.fyi" },
    realm: "reddit.surf.cascade.fyi",
    intent: "charge",
    payment: TEMPO_PAYMENT,
    endpoints: [
      { route: "GET /search", desc: "Search Reddit posts", amount: "5000" },
      { route: "GET /r/:subreddit", desc: "Get subreddit info", amount: "1000" },
      { route: "GET /r/:subreddit/posts", desc: "Get posts from a subreddit", amount: "3000" },
      { route: "GET /posts/:id", desc: "Get a post with comments", amount: "4000" },
      { route: "GET /users/:username", desc: "Get user profile", amount: "1000" },
      { route: "GET /users/:username/posts", desc: "Get a user's posts", amount: "4000" },
      { route: "GET /users/:username/comments", desc: "Get a user's comments", amount: "4000" },
    ],
  },
  ...
  // ── Surf Web ─────────────────────────────────────────────────────────
  {
    ...
    serviceUrl: "https://web.surf.cascade.fyi",
    description: "Web crawling and search API. Crawl any URL to markdown or search the web with AI-powered results.",
    ...
    docs: {
      homepage: "https://surf.cascade.fyi",
      apiReference: "https://web.surf.cascade.fyi",
    },
    provider: { name: "Cascade", url: "https://surf.cascade.fyi" },
    realm: "web.surf.cascade.fyi",
    intent: "charge",
    payment: TEMPO_PAYMENT,
    endpoints: [
      { route: "POST /v1/crawl", desc: "Crawl a URL and return content as markdown or HTML", amount: "5000" },
      { route: "POST /v1/search", desc: "Search the web with AI-powered results", amount: "10000" },
    ],
  },
];
