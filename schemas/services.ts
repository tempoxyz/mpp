...
export const services: ServiceDef[] = [
  ...
  {
    id: "business-entity-search",
    name: "Secretary of State Business Entity Search + UCC Liens — KYB",
    url: "https://www.scotthelvick.com/records-api/#secretary-of-state-business-entity-search--ucc-liens--kyb",
    serviceUrl: "https://records-mpp.fly.dev",
    description:
      "Secretary of State (SOS) business entity search across official US state registries — status, formation, registered agent lookup, company officers and directors — joined to UCC lien filings. Search UCC filings by debtor name: secured party, status. KYB verification for lending and diligence agents.",
    icon: "https://records-mpp.fly.dev/favicon.svg",
    categories: ["data", "search"],
    integration: "first-party",
    tags: [
      "secretary-of-state",
    ...
    docs: {
      homepage:
        "https://www.scotthelvick.com/records-api/#secretary-of-state-business-entity-search--ucc-liens--kyb",
      llmsTxt: "https://records-mpp.fly.dev/llms.txt",
    },
    provider: { name: "Scott Helvick", url: "https://www.scotthelvick.com" },
    realm: "records-mpp.fly.dev",
    intent: "charge",
    payments: [TEMPO_PAYMENT, STRIPE_PAYMENT],
    endpoints: [
      {
        route: "GET /entity/search",
        desc: "Secretary of State business entity search by name — sized quote per record",
        dynamic: true,
        amountHint: "5000",
        unitType: "record",
      },
      {
        route: "GET /entity/ucc",
        desc: "UCC lien filings by debtor name — secured party, status",
        dynamic: true,
        amountHint: "40000",
        unitType: "filing",
      },
      {
        ...
        desc: "Full-coverage results via POST /entity/jobs (40+ states); extended-state records 40000",
        dynamic: true,
        amountHint: "5000",
        unitType: "record",
      },
  ...
  {
    id: "county-property-records",
    name: "County Property Records API — Owner, Value, Tax & Assessor Data",
    url: "https://www.scotthelvick.com/records-api/#county-property-records-api--owner-value-tax--assessor-data",
    serviceUrl: "https://records-mpp.fly.dev",
    description:
    ...
    docs: {
      homepage:
        "https://www.scotthelvick.com/records-api/#county-property-records-api--owner-value-tax--assessor-data",
      llmsTxt: "https://records-mpp.fly.dev/llms.txt",
    },
    provider: { name: "Scott Helvick", url: "https://www.scotthelvick.com" },
    realm: "records-mpp.fly.dev",
    ...
    endpoints: [
      {
        route: "GET /parcel/search",
        desc: "Property records by address or parcel ID — sized quote per record",
        dynamic: true,
        amountHint: "50000",
        unitType: "record",
      },
      {
        route: "GET /parcel/owner",
        desc: "Owner search incl. company and LLC portfolios — sized quote per record",
        dynamic: true,
        amountHint: "50000",
        unitType: "record",
      },
      {
        route: "GET /jobs/{job_id}/result",
        desc: "Full-coverage results via POST /parcel/jobs (1,350+ counties)",
        dynamic: true,
        amountHint: "50000",
        unitType: "record",
      },
  ...
  {
    id: "deed-records-search",
    name: "Property Deed & Lien Records Search",
    url: "https://www.scotthelvick.com/records-api/#property-deed--lien-records-search",
    serviceUrl: "https://records-mpp.fly.dev",
    description:
    ...
    categories: ["data", "search"],
    integration: "first-party",
    tags: ["deeds", "title", "recorder", "liens", "mortgages", "government"],
    docs: {
      homepage:
        "https://www.scotthelvick.com/records-api/#property-deed--lien-records-search",
      llmsTxt: "https://records-mpp.fly.dev/llms.txt",
    },
    provider: { name: "Scott Helvick", url: "https://www.scotthelvick.com" },
    realm: "records-mpp.fly.dev",
    ...
    endpoints: [
      {
        route: "GET /deed/search",
        desc: "Recorded deeds, mortgages, releases, liens by party name — sized quote per record",
        dynamic: true,
        amountHint: "5000",
        unitType: "record",
      },
      {
        route: "GET /jobs/{job_id}/result",
        desc: "Full-coverage results via POST /deed/jobs",
        dynamic: true,
        amountHint: "5000",
        unitType: "record",
      },
