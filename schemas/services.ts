...
export const services: ServiceDef[] = [
  {
    ...
    serviceUrl: "https://api.signalnodus.ai",
    description:
      "Year-over-year diffs of SEC filing sections pinned to accession numbers, plus 8-K events, insider trades, 13F holdings, XBRL claim verification, US federal contracts and lobbying, CFTC positioning, EIA energy and US trade flows.",
    icon: "https://signalnodus.ai/icon.svg",
    ...
    docs: {
      ...
      llmsTxt: "https://signalnodus.ai/llms.txt",
      apiReference: "https://api.signalnodus.ai/openapi.json",
    },
    provider: { name: "Signal Nodus", url: "https://signalnodus.ai" },
    realm: "api.signalnodus.ai",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      { route: "GET /v1/compare", desc: "Sentence-level year-over-year diff of one filing item", amount: "500000", unitType: "request" },
      { route: "GET /v1/score/churn", desc: "Risk-factor churn as one number with a verdict band", amount: "100000", unitType: "request" },
      { route: "GET /v1/verify/claim", desc: "Check a numeric claim against as-filed XBRL", amount: "100000", unitType: "request" },
      { route: "GET /v1/x402/audit", desc: "Audit a public x402 endpoint’s challenge", amount: "100000", unitType: "request" },
      { route: "GET /v1/token/report", desc: "One-call token due-diligence data", amount: "100000", unitType: "request" },
      { route: "GET /v1/section", desc: "Extract one item from a filing as clean text", amount: "50000", unitType: "request" },
      { route: "GET /v1/insider", desc: "Parsed Form 4 insider transactions", amount: "50000", unitType: "request" },
      { route: "GET /v1/holdings", desc: "A manager’s latest 13F, top positions by value", amount: "50000", unitType: "request" },
      { route: "GET /v1/whoholds", desc: "Which 13F managers hold a company", amount: "50000", unitType: "request" },
      { route: "GET /v1/events", desc: "8-K material events with decoded item codes", amount: "50000", unitType: "request" },
      { route: "GET /v1/activists", desc: "13D/13G ownership stakes", amount: "50000", unitType: "request" },
      { route: "GET /v1/gov/contracts", desc: "US federal contract awards by recipient", amount: "50000", unitType: "request" },
      { route: "GET /v1/gov/lobbying", desc: "US Senate LDA lobbying disclosures", amount: "50000", unitType: "request" },
      { route: "GET /v1/gas/optimizer", desc: "Cheapest gas across chains in USD", amount: "50000", unitType: "request" },
      { route: "GET /v1/cftc/positioning", desc: "CFTC Commitments of Traders positioning", amount: "50000", unitType: "request" },
      { route: "GET /v1/energy", desc: "US energy prices and grid demand from EIA", amount: "50000", unitType: "request" },
      { route: "GET /v1/crops", desc: "USDA crop and livestock estimates", amount: "50000", unitType: "request" },
      { route: "GET /v1/trade", desc: "US imports and exports by HS chapter and partner", amount: "50000", unitType: "request" },
      { route: "GET /v1/filings", desc: "List recent filings with accession numbers", amount: "10000", unitType: "request" },
      { route: "GET /v1/financials", desc: "As-reported XBRL facts for one concept", amount: "10000", unitType: "request" },
      { route: "GET /v1/latest", desc: "Market-wide feed of filings as they land", amount: "10000", unitType: "request" },
      { route: "GET /v1/evm/balance", desc: "Native balance of an EVM address", amount: "10000", unitType: "request" },
      { route: "GET /v1/evm/gas", desc: "Current gas price on an EVM chain", amount: "10000", unitType: "request" },
      { route: "GET /v1/evm/receipt", desc: "Transaction receipt on an EVM chain", amount: "10000", unitType: "request" },
      { route: "GET /v1/token/price", desc: "Token price and 24h volume", amount: "10000", unitType: "request" },
      { route: "GET /v1/fx/rate", desc: "ECB reference foreign-exchange rates", amount: "10000", unitType: "request" },
      { route: "GET /v1/domain/report", desc: "DNS and RDAP report for a domain", amount: "10000", unitType: "request" },
      { route: "GET /v1/markets/prediction", desc: "Prediction-market questions by volume", amount: "10000", unitType: "request" },
      { route: "GET /v1/search", desc: "EDGAR full-text search", amount: "10000", unitType: "request" },
      { route: "GET /v1/ipos", desc: "Recent S-1 and F-1 IPO registrations", amount: "10000", unitType: "request" },
      { route: "GET /v1/company", desc: "Resolve a ticker or name to a CIK (free)" },
    ],
  },
  // ── Apex DB ───────────────────────────────────────────────────────────
  {
