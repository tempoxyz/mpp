...
export const services: ServiceDef[] = [
  ...
  // ── Build With Locus ───────────────────────────────────────────────────
  {
    ...
    url: "https://api.buildwithlocus.com",
    serviceUrl: "https://api.buildwithlocus.com",
    description:
    ...
    endpoints: [
      ...
      { route: "GET /v1/billing/balance", desc: "Credit balance and billing summary" },
      { route: "GET /v1/billing/transactions", desc: "Credit ledger history" },
      { route: "GET /v1/billing/services", desc: "Billable services with rate breakdown" },
      // Projects
      ...
      // Environments
      { route: "POST /v1/projects/:projectId/environments", desc: "Create environment" },
      { route: "GET /v1/projects/:projectId/environments", desc: "List environments" },
      { route: "GET /v1/projects/:projectId/environments/:envId", desc: "Get environment" },
      { route: "DELETE /v1/projects/:projectId/environments/:envId", desc: "Delete environment" },
      // Services
      ...
      { route: "GET /v1/services/environment/:environmentId", desc: "List services in environment" },
      { route: "POST /v1/services/:serviceId/restart", desc: "Rolling restart without rebuild" },
      { route: "POST /v1/services/:serviceId/redeploy", desc: "Redeploy latest image" },
      // Deployments
      { route: "POST /v1/deployments", desc: "Trigger deployment" },
      { route: "GET /v1/deployments/:deploymentId", desc: "Get deployment status" },
      { route: "GET /v1/deployments/service/:serviceId", desc: "List deployments for service" },
      { route: "POST /v1/deployments/:deploymentId/cancel", desc: "Cancel deployment" },
      { route: "POST /v1/deployments/:deploymentId/rollback", desc: "Rollback to previous image" },
      { route: "GET /v1/deployments/:deploymentId/logs", desc: "Stream deployment logs (SSE)" },
      // Variables
      { route: "PUT /v1/variables/service/:serviceId", desc: "Replace all service variables" },
      { route: "PATCH /v1/variables/service/:serviceId", desc: "Merge service variables" },
      { route: "GET /v1/variables/service/:serviceId/resolved", desc: "Resolved variables with addon injections" },
      // Monorepo
      { route: "POST /v1/projects/from-repo", desc: "Deploy full stack from GitHub repo" },
      { route: "POST /v1/projects/from-locusbuild", desc: "Deploy from inline .locusbuild config" },
      // Addons
      { route: "POST /v1/addons", desc: "Create Postgres or Redis addon" },
      { route: "GET /v1/addons/:addonId", desc: "Get addon status" },
      { route: "GET /v1/addons/environment/:envId", desc: "List addons in environment" },
      ...
      { route: "POST /v1/domains/:domainId/verify", desc: "Verify domain CNAME and cert" },
      { route: "POST /v1/domains/:domainId/attach", desc: "Attach domain to service" },
