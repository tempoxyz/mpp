...
export const services: ServiceDef[] = [
  ...
  // ── Sentinel ──────────────────────────────────────────────────────────
  {
    ...
    serviceUrl: "https://sentinel.rootstuff.io/mpp",
    description:
      "Pay-per-call uptime checks and probes from four monitoring regions (Ashburn, Portland, Nuremberg, Singapore), plus timers, URL watches and a dead-man switch that deliver signed callbacks. Every paid response carries an Ed25519-signed receipt.",
    icon: "https://sentinel.rootstuff.io/images/icon-512-square.png",
    categories: ["web", "data"],
    integration: "first-party",
    tags: [
      "uptime",
    ...
    status: "active",
    docs: {
      homepage: "https://sentinel.rootstuff.io/mpp",
      llmsTxt: "https://sentinel.rootstuff.io/llms.txt",
      apiReference: "https://sentinel.rootstuff.io/mpp/openapi.json",
    },
    provider: { name: "Rootstuff", url: "https://rootstuff.io" },
    realm: "sentinel.rootstuff.io",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      {
        route: "POST /check",
        desc: "Four-region consensus check of a URL",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "POST /payment-envelope",
        desc: "Read a paid endpoint's 402 challenge (x402 or MPP) without paying it",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "POST /ssl",
        desc: "TLS certificate and handshake grade for a host",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /dns",
        desc: "Every DNS record for a domain plus propagation across public resolvers",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /domain",
        desc: "Registration expiry and registrar for a domain",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /headers",
        desc: "Response headers and security-header report for a URL",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /redirects",
        desc: "Redirect chain from a URL to its final destination",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /port",
        desc: "TCP port reachability and connect latency",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /ping",
        desc: "ICMP ping latency and packet loss",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /wake",
        desc: "Timer: one signed callback at a time you choose (10s to 7 days)",
        amount: "10000",
        unitType: "callback",
      },
      {
        route: "POST /deadman",
        desc: "Dead-man switch: a signed callback when your heartbeats stop",
        amount: "50000",
        unitType: "switch",
      },
      {
        route: "POST /watch-1h",
        desc: "Watch a URL for 1 hour: signed callbacks when its verdict changes",
        amount: "50000",
        unitType: "watch",
      },
      {
        route: "POST /watch-6h",
        desc: "Watch a URL for 6 hours: signed callbacks when its verdict changes",
        amount: "200000",
        unitType: "watch",
      },
      {
        route: "POST /watch-24h",
        desc: "Watch a URL for 24 hours: signed callbacks when its verdict changes",
        amount: "500000",
        unitType: "watch",
      },
    ],
