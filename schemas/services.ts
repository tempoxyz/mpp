...
export const services: ServiceDef[] = [
  ...
  },
  {
    id: "verify-api",
    name: "Verify API",
    url: "https://verify.drain54.my.id",
    serviceUrl: "https://verify.drain54.my.id",
    description:
      "Deterministic fact-checking, AI infrastructure claims verification, stealth web extraction, and structured scraping for autonomous agents.",
    ...
    status: "active",
    docs: {
      homepage: "https://verify.drain54.my.id",
      apiReference: "https://verify.drain54.my.id/openapi.json",
    },
    provider: { name: "drain54", url: "https://github.com/drain54/verify-api" },
    realm: "verify.drain54.my.id",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      {
        route: "POST /mpp/v1/verify",
        desc: "Verify AI infrastructure claims with deterministic web evidence",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /mpp/v1/read",
        desc: "Read and extract clean markdown content from URL",
        amount: "5000",
        unitType: "request",
      },
      {
        route: "POST /mpp/v1/extract-json",
        desc: "Extract structured JSON data matching custom schema from target webpage",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /mpp/v1/fetch-stealth",
        desc: "Fetch webpage HTML with anti-bot challenge detection and stealth headers",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/info",
        desc: "MPP service metadata and pricing directory",
        amount: "0",
        unitType: "request",
      },
    ],
