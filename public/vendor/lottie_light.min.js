"undefined" != typeof document &&
  ...
  ((t, e) => {
    ...
    function r(t, e) {
      ...
      for (i = 0; i < a; i += 1)
        for (var r in (s = t[i].prototype))
          Object.hasOwn(s, r) && (e.prototype[r] = s[r]);
    }
    function n(t) {
      function e() {}
    ...
    var $ = (() => {
      ...
      et = { double: (t) => t.concat(l(t.length)) },
      it = (t, e, i) => {
        var s = 0,
          a = t,
          r = l(a);
        return {
          newElement: () => (s ? r[(s -= 1)] : e()),
          release: (t) => {
    ...
    var rt = (() => {
        ...
        return {
          ...
          buildBezierData: n,
          pointOnLine2D: e,
          pointOnLine3D: (i, s, a, r, n, o, h, l, p) => {
    ...
    var xt,
      ...
      Mt =
        ((xt = {
          newShapeCollection: () => (wt ? Ct[(wt -= 1)] : new St()),
          release: (t) => {
            var e,
              i = t._length;
    ...
    (It.play = $.play),
      ...
      (It.loadAnimation = (t) => $.loadAnimation(t)),
      (It.setSubframeRendering = (t) => {
        !((t) => {
          f = !!t;
        })(t);
      }),
      ...
      (It.inBrowser = () => "undefined" != typeof navigator),
      (It.installPlugin = (t, e) => {
        "expressions" === t && (d = e);
      }),
      (It.freeze = $.freeze),
    ...
    var Bt = (() => {
      ...
      return (
        ...
        (t.getModifier = (t, i, s) => new e[t](i, s)),
        t
      );
    })();
    function qt() {}
    function jt() {}
    function Wt() {}
    (qt.prototype.initModifierProperties = () => {}),
      (qt.prototype.addShapeToModifier = () => {}),
      ...
      (jt.prototype.addShapeToModifier = (t) => {
        t.pathsData = [];
      }),
      (jt.prototype.calculateShapeEdges = (t, e, i, s, a) => {
        var r = [];
        e <= 1
          ? r.push({ s: t, e: e })
          : t >= 1
      ...
      (jt.prototype.releasePathsData = (t) => {
        var e,
          i = t.length;
    ...
    var Xt = (() => {
      ...
      return (
        ...
        { getTransformProperty: (t, i, s) => new e(t, i, s) }
      );
    })();
    function Ht() {}
    function Yt() {}
    ...
    function de(t, e, i, s, a, r, n) {
      var o = fe(e, i),
        ...
        p = e.v[(i + 1) % e._length],
        f = 2 === r ? Math.sqrt((h[0] - l[0]) ** 2 + (h[1] - l[1]) ** 2) : 0,
        d = 2 === r ? Math.sqrt((h[0] - p[0]) ** 2 + (h[1] - p[1]) ** 2) : 0;
    ...
    function be(t, e) {
      ...
      var o = (n[1] - n[0]) / (1 - n[0]);
      return (
        (r = (a = a[1].split(o))[0]), (s = a[1]), [ue(i, e), ue(r, e), ue(s, e)]
      );
    }
    function _e() {}
    function ke(t) {
    ...
    r([qt], Ht),
      ...
      (Ht.prototype.applyTransforms = (t, e, i, s, a, r) => {
        var n = r ? -1 : 1,
            ...
            a[0] === n[0] && a[1] === n[1] && a[0] === r[0] && a[1] === r[1]
              ? (0 !== i && i !== g - 1) || t.c
                ? ((o = 0 === i ? t.v[g - 1] : t.v[i - 1]),
                  (l = (h = Math.sqrt((a[0] - o[0]) ** 2 + (a[1] - o[1]) ** 2))
                    ? Math.min(h / 2, e) / h
                    : 0),
                  (p = c = a[0] + (o[0] - a[0]) * l),
                  (f = u = a[1] - (a[1] - o[1]) * l),
      ...
      (le.prototype.processPath = (t, e, i, s) => {
        var a = t._length,
          r = At.newElement();
      ...
      (_e.prototype.processPath = (t, e, i, s) => {
        var a = At.newElement();
        a.c = t.c;
        var r,
          n,
    ...
    var Pe = (() => {
      ...
      (l.isModifier = (t, e) => {
        ...
        (l.isFlagEmoji = (t) => h(t.substr(0, 2)) && h(t.substr(2, 2))),
        (l.isRegionalCode = h),
    ...
    r([bt], Re),
      ...
      (Ne.prototype.prepareFrame = () => {}),
      r([Se, ze, Oe], Ne),
      (Ne.prototype.getBaseElement = () => null),
      (Ne.prototype.renderFrame = () => {}),
      (Ne.prototype.destroy = () => {}),
      ...
      (Be.prototype.getBaseElement = () => null),
      (Be.prototype.destroy = () => {}),
      (Be.prototype.sourceRectAtTime = () => {}),
      (Be.prototype.initExpressions = () => {}),
      ...
      (qe.prototype.setupGlobalData = function (t, e) {
        (this.globalData.fontManager = new Pe()),
          (this.globalData.slotManager = ((t) => new Ae(t))(t)),
    ...
    r([ze, We, Ue, ei, Ze, Oe, Qe], yi),
      (yi.prototype.initSecondaryElement = () => {}),
      (yi.prototype.identityMatrix = new Ft()),
      (yi.prototype.buildExpressionInterface = () => {}),
      ...
      (yi.prototype.setShapesAsAnimated = (t) => {
        var e,
          i = t.length;
      ...
      (yi.prototype.createGroupElement = (t) => {
        var e = new mi();
        return (
    ...
    var _i = (() => {
      ...
      return (
        ...
        r([bt], s),
        { getTextSelectorProp: (t, e, i) => new s(t, e, i) }
      );
    })();
    function ki(t, e, i) {
      var s = { propType: !1 },
    ...
    (Pi.prototype.searchProperties = function () {
      ...
      (Ai.prototype.createPathShape = (t, e) => {
        var i,
          s,
          a = e.length,
          r = "";
      ...
      (Ai.prototype.applyTextPropertiesToMatrix = (t, e, i, s, a) => {
        switch (
    ...
    return (
      ...
      (wi.prototype.buildTextContents = (t) => {
      ...
      (wi.prototype.buildShapeData = (t, e) => {
      ...
      (Ci.prototype.renderFrame = () => {}),
      (Ci.prototype.getBaseElement = () => null),
      (Ci.prototype.destroy = () => {}),
      (Ci.prototype.sourceRectAtTime = () => {}),
      (Ci.prototype.hide = () => {}),
      r([ze, We, Ze, Oe], Ci),
      r([qe], Mi),
      ...
      (Mi.prototype.updateContainerSize = () => {}),
