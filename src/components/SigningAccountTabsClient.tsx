  ...
  return (
    <Tabs.Root defaultValue="private-key">
      ...
      <Tabs.Panel className="vocs:pt-4" value="privy">
        <p>
          Create an EVM server wallet in{" "}
          <a href="https://dashboard.privy.io">Privy</a>, fund its address with
          pathUSD on Tempo, and install <code>@privy-io/node</code> version{" "}
          <code>0.20.0</code> or later. Keep <code>PRIVY_APP_SECRET</code>{" "}
          server-side.
        </p>
        <CodeExample
