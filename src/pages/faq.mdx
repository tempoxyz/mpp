...
- **IETF standards track.** The core [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is submitted to the IETF for standardization.
...
MPP is co-authored by Tempo and Stripe. The core specification is developed in the open and designed to be extended by any payment network or provider. The [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is submitted to the IETF.
