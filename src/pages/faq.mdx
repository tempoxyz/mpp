...
- **IETF Internet-Draft.** The core [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is an active individual submission with intended status Standards Track.
...
The core [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is an active individual IETF Internet-Draft with intended status Standards Track. It is not yet an IETF standard. Payment method and intent specifications (for example, charge, session) are separate documents that anyone can author and publish independently—they do not require IETF approval.
...
MPP is co-authored by Tempo and Stripe. The core specification is developed in the open and designed to be extended by any payment network or provider. The [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is published as an active IETF Internet-Draft.
