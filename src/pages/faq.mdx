...
- **IETF Specification.** The core [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) is submitted to the IETF for standardization.
