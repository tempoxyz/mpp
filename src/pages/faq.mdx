...
See [MPP vs x402](/mpp-vs-x402) for a full side-by-side comparison, or [Add x402 to your MPP server with mppx](/guides/upgrade-x402#add-x402-to-your-mpp-server-with-mppx) for an implementation guide.
...
Yes. The core x402 "exact" flows map directly onto MPP's charge intent. `mppx` can serve x402 and MPP clients from the same route. See [Add x402 to your MPP server with mppx](/guides/upgrade-x402#add-x402-to-your-mpp-server-with-mppx).
