...
| `x402-proxy` | TypeScript, JavaScript | curl for x402 and MPP endpoints - auto-pays charge and session-based flows with built-in wallet, spend limits, and MCP proxy for AI agents | [npm](https://www.npmjs.com/package/x402-proxy) · [GitHub](https://github.com/cascade-protocol/x402-proxy) |
