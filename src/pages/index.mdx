...
| [Python](/sdk/python) | [`pympay`](https://pypi.org/project/pympay/) | [tempoxyz/pympay](https://github.com/tempoxyz/pympay) | [Tempo Labs](https://github.com/tempoxyz) | <Badge variant="note">Beta</Badge> |
| [Rust](/sdk/rust) | [`mpay`](https://crates.io/crates/mpay) | [tempoxyz/mpay-rs](https://github.com/tempoxyz/mpay-rs) | [Tempo Labs](https://github.com/tempoxyz) | <Badge variant="note">Beta</Badge> |
