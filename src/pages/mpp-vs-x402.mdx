...
For a working server setup, see [Add x402 to your MPP server with mppx](/guides/upgrade-x402#add-x402-to-your-mpp-server-with-mppx).
...
<Cards>
  <Card title="Run x402 with mppx" description="Serve x402 and MPP from one route" to="/guides/upgrade-x402#add-x402-to-your-mpp-server-with-mppx" />
