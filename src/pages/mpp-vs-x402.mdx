...
For a working server setup, see [Running x402 servers with mppx](/guides/upgrade-x402#running-x402-servers-with-mppx).
...
<Cards>
  <Card title="Run x402 with mppx" description="Serve x402 and MPP from one route" to="/guides/upgrade-x402#running-x402-servers-with-mppx" />
