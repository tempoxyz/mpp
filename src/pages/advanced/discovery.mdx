...
| [mpp.land](https://mpp.land) | Open registry with compliance scoring, uptime monitoring, and LLM-friendly endpoints | [Submit a PR](https://github.com/mppland/submit) or email [contact@mpp.land](mailto:contact@mpp.land) |
