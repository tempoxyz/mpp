...
| [`mppx` CLI](#mppx) | Development and debugging | `stripe`, `tempo` | `mppx account create` |
...
**Built-in methods:** <Badge variant="info">stripe.charge</Badge> <Badge variant="info">tempo.charge</Badge> <Badge variant="info">tempo.session</Badge>
