...
sequenceDiagram
    ...
    Note over Client: (3) Fulfill payment (sign tx, pay invoice, etc.)
...
For metered or usage-based billing where the total cost isn't known upfront, use the stream intent instead.
