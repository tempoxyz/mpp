...
The core specification is published as the [Payment HTTP Authentication Scheme](https://datatracker.ietf.org/doc/draft-httpauth-payment/) and submitted to the **IETF** standards track, where it continues to progress as an open, vendor-neutral standard.
