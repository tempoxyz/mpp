...
MPP now supports subscriptions, beginning with Tempo stablecoin payments. Subscriptions let a client authorize recurring payments once, then reuse paid access across requests.
...
<MermaidDiagram chart={`sequenceDiagram
    ...
    Server->>Settlement layer: Charge first billing period
