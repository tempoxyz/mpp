...
showFeedback: false
showSearch: false
description: "Tempo subscriptions bring recurring stablecoin access to MPP for plans, memberships, and paid API tiers."
imageDescription: "Recurring API access with Tempo subscriptions"
---
...
- **Sessions** work best when usage changes during a request, such as streamed tokens or bytes.
