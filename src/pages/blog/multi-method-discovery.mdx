...
It has been a month since MPP launched, and the ecosystem is growing fast. Over ten payment methods are live across the protocol, spanning stablecoins on very EVM network, cards, and even Bitcoin. As more methods have been added, we have seen more services accepting multiple payment methods, multiple currencies, and multiple intent types on the same endpoint.
