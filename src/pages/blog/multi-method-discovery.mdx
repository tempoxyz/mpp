...
<a href="/blog" className="blog-back"><span className="blog-back-label">Blog</span></a>
...
The flat single-offer form remains valid for backward compatibility, but new documents use the multi-offer form.
