...
Use [`stripe.create`](/sdk/typescript/server/Method.stripe.create) as the default server setup. It resolves your Tempo deposit address, registers Tempo and SPT charge methods, and records completed stablecoin payments in Stripe.
