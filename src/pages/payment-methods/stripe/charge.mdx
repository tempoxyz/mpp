...
Request-scoped metadata overrides matching integration-level and per-method keys. `mppx` sets `machine_payment: 'true'` by default; matching metadata overrides it.
