...
Use this for polling, free follow-up requests, and unlock flows after an initial payment. It also removes a griefing vector where an identity-only request could still force the end user to burn a small network fee.
