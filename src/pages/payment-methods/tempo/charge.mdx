...
The client adds a Challenge-bound attribution memo to the primary transfer, and the server verifies it. Custom top-level memos aren't supported. Split transfers can still include their own memos.
