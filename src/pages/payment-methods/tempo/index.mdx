...
- **High throughput**—Tempo's throughput handles the on-chain settlement and channel management volume that session-based payments generate at scale
...
<Cards>
  <Card
    ...
    icon="lucide:waves"
    title="Session"
    description="Pay-as-you-go session payments over payment channels"
