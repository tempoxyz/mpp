...
When `x402.facilitator` is configured, the server returns MPP and x402 Challenges and accepts both MPP and x402 Credentials. See [running x402 servers with mppx](/guides/upgrade-x402#add-x402-to-your-mpp-server-with-mppx) for the full guide.
