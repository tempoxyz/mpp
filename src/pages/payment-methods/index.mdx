...
import { TempoMethodCard, CardMethodCard, EvmMethodCard, LightningMethodCard, MonadMethodCard, NearIntentsMethodCard, RedotPayMethodCard, StellarMethodCard, XrplMethodCard, SolanaMethodCard, StripeMethodCard, CustomMethodCard } from '../../components/cards'
...
```http
HTTP/1.1 402 Payment Required
WWW-Authenticate: Payment method="xrpl", intent="charge", ...
```
  </Tab>
  <Tab title="Stellar">
```http
