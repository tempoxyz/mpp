...
import { TempoMethodCard, CardMethodCard, EvmMethodCard, LightningMethodCard, MonadMethodCard, NearIntentsMethodCard, RedotPayMethodCard, StellarMethodCard, SolanaMethodCard, StripeMethodCard, CustomMethodCard } from '../../components/cards'
