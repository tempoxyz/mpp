...
- **SEP-41 token support**: Any SEP-41-compliant token is supported. SAC is one implementation covering native Stellar assets like USDC and XLM
...
The `@stellar/mpp` package exports constants for common token addresses:
