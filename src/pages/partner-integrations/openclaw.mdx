...
Install Privy's OpenClaw skill when the agent needs a Privy server wallet for onchain actions. Create a Privy app first, then keep its app secret in the OpenClaw configuration—not in a skill or source file.
