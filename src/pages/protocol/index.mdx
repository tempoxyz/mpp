...
<Cards>
  ...
  <SpecCard to="https://paymentauth.org" title="Payment Methods" description="Payment method definitions" />
  <SpecCard to="https://paymentauth.org" title="Payment Intents" description="Intent type definitions (for example, charge, session)" />
  ...
  <SpecCard to="https://paymentauth.org" title="HTTP Transport" description="HTTP binding details" />
</Cards>
