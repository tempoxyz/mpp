...
These docs provide a developer-friendly overview. Read the [IETF Specification](https://datatracker.ietf.org/doc/draft-httpauth-payment/) for the normative core protocol.
...
<Cards>
  <SpecCard to="https://datatracker.ietf.org/doc/draft-httpauth-payment/" title="Payment HTTP Authentication Scheme" description="Core IETF Specification" />
