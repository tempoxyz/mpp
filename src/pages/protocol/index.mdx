...
These docs provide a developer-friendly overview. Read the [IETF Internet-Draft](https://datatracker.ietf.org/doc/draft-httpauth-payment/) for the core protocol submission.
...
<Cards>
  <SpecCard to="https://datatracker.ietf.org/doc/draft-httpauth-payment/" title="Payment HTTP Authentication Scheme" description="Active IETF Internet-Draft (draft-httpauth-payment-01)" />
  ...
  <SpecCard to="https://paymentauth.org" title="IETF Specification" description="Browse the full specification directory" />
</Cards>
