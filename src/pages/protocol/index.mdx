...
<Cards>
  <SpecCard to="https://tempoxyz.github.io/mpp-specs/draft-httpauth-payment-00" title="Payment HTTP Authentication Scheme" description="Core protocol spec (draft-httpauth-payment-00)" />
  <SpecCard to="https://tempoxyz.github.io/mpp-specs/" title="Payment Methods" description="Payment method definitions" />
  <SpecCard to="https://tempoxyz.github.io/mpp-specs/" title="Payment Intents" description="Intent type definitions (for example, charge, session)" />
  <SpecCard to="https://tempoxyz.github.io/mpp-specs/draft-payment-transport-mcp-00" title="MCP Transport" description="Model Context Protocol binding" />
  <SpecCard to="https://tempoxyz.github.io/mpp-specs/" title="HTTP Transport" description="HTTP binding details" />
</Cards>
