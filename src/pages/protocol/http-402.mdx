---
description: "HTTP 402 Payment Required is the status code for paid resources. MPP standardizes 402 with a challenge–credential–receipt flow for machine-to-machine payments."
