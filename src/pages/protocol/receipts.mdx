...
| Payment method and intent | Reference format |
|---------------------------|------------------|
| `stripe/charge` | PaymentIntent ID (`pi_1234...`) |
| `tempo/charge` | Transaction hash (`0x789...`) |
| `tempo/session` | Channel ID; settlement and close Receipts may also include `txHash` |
