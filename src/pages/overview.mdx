...
- **Open standard built for the internet**—Built on an [open specification published as an IETF Internet-Draft](https://datatracker.ietf.org/doc/draft-httpauth-payment/), not a proprietary API
