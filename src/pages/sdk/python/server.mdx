...
Register event handlers to monitor issued Challenges, successful payments, and rejected Credentials. Typed helpers cover common events, string names map to the lifecycle event names, and `*` receives every server event.
