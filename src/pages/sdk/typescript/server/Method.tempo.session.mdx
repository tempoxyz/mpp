...
Account used to close and settle payment channels on-chain. The account address is also used as the default recipient. Without this, channel close and settlement fails.
