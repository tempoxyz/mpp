...
The resolver receives `challenge`, `credential`, optional verified `envelope`, and canonical `request` fields. `mppx` doesn't call it for the initial Challenge or an invalid Credential. Resolver errors stop PaymentIntent creation.
