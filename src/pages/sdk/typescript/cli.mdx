...
The `mppx` package includes a bundled CLI runtime for making HTTP requests with automatic payment handling. Published packages omit the CLI source files and source maps.
