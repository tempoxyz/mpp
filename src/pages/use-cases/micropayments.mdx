...
<Cards>
  <Cards.Card title="Accept one-time payments" description="Charge per request with on-chain settlement" href="/guides/one-time-payments" />
  <Cards.Card title="Accept pay-as-you-go payments" description="Sub-cent billing with payment sessions" href="/guides/pay-as-you-go" />
  <Cards.Card title="Accept streamed payments" description="Bill per token in real time" href="/guides/streamed-payments" />
</Cards>
