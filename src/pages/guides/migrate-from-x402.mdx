...
```ts [server.ts]
import crypto from 'crypto' // [!code ++]
import express from 'express'
import { paymentMiddleware } from '@x402/express' // [!code --]
import { Mppx, tempo } from 'mppx/express' // [!code ++]

const app = express()

app.use( // [!code --]
  paymentMiddleware({ // [!code --]
    'GET /api/data': { // [!code --]
      amount: '10000', // [!code --]
      asset: '0x20c0000000000000000000000000000000000000', // [!code --]
      description: 'Premium data access', // [!code --]
      maxTimeoutSeconds: 60, // [!code --]
      network: 'eip155:8453', // [!code --]
      payTo: '0xYourAddress', // [!code --]
      scheme: 'exact', // [!code --]
    }, // [!code --]
  }), // [!code --]
) // [!code --]

const mppx = Mppx.create({ // [!code ++]
  secretKey: process.env.MPP_SECRET_KEY || crypto.randomBytes(32).toString('base64'), // [!code ++]
  methods: [ // [!code ++]
    tempo({ // [!code ++]
      currency: '0x20c0000000000000000000000000000000000000', // [!code ++]
      recipient: '0xYourAddress', // [!code ++]
      testnet: true, // [!code ++]
    }), // [!code ++]
  ], // [!code ++]
}) // [!code ++]

app.get('/api/data', (req, res) => { // [!code --]
  res.json({ data: 'premium content' }) // [!code --]
}) // [!code --]
app.get( // [!code ++]
  '/api/data', // [!code ++]
  mppx.charge({ amount: '0.01', description: 'Premium data access' }), // [!code ++]
  (req, res) => { // [!code ++]
    res.json({ data: 'premium content' }) // [!code ++]
  }, // [!code ++]
) // [!code ++]
