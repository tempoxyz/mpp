...
`evm.charge` on the client signs native MPP EVM charge Challenges, route-bound x402 exact Challenges from `mppx` servers, and standard x402 v2 EIP-3009 Challenges. Standard providers don't need to include the optional `mppx` route-binding extension.
