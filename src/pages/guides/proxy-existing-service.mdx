...
Put a payment gate in front of an existing API without modifying it. The proxy sits between clients and the origin, handles the `402` Challenge→Credential→Receipt flow, injects upstream credentials, and forwards paid requests.
