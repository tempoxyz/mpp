...
Each split can carry its own on-chain memo for reconciliation. The primary transfer uses the SDK-generated Challenge-bound attribution memo and doesn't accept a custom memo.
...
Mppx.create({
  methods: [
    tempo.charge({
      ...
      // [!code hl:start]
      expectedRecipients: [
        '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', // seller (primary)
